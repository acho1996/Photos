...
public class Controller {
	...
	public void gotoHomePage() {
		changeScene("NonAdminHome.fxml", 500, 500, false);
	}
	
	/**
	 *  Changes scene to Album View
	 */
	public void gotoAlbumContent() {
		changeScene("AlbumContent.fxml", 900, 530, false);
	}
	
	/**
	 *  Changes scene to Image Search page
	 */
	public void gotoSearchPhoto() {
		changeScene("SearchPhotos.fxml", 580, 530, false);
	}
	...
	public void gotoAdminHome() {
		changeScene("AdminHome.fxml", 600, 448, false);
	}
